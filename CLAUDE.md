...
| 運営 OS Phase 30〜41 実装 | `docs/projects/operating-spec-phase-30-plan.md` | ✅ ほぼ完了（Phase 30〜43 完了。Phase 43 で daily Runner / carry_over 全 Runner 適用 / scope_level 統一を実装済み。Phase 44 残件: DB化・heartbeat駆動・enforce ON は別セッション） |
