# LedgerV2::EvaluateImprovementJob — EvaluateImprovement を RunExecutor 経由で起動するジョブ。
#
# 責務:
# - RunExecutor.call(:evaluate_improvement, ...) を呼ぶだけ
...
module LedgerV2
  class EvaluateImprovementJob < ApplicationJob
    queue_as :default
