...
| 運営 OS Phase 30〜41 実装 | `docs/projects/operating-spec-phase-30-plan.md` | 🔧 進行中（Phase 30a + 30b 完了：idempotency_key 自動採番 / PreflightValidator / carry_over_items 書き込み。30c 以降は別 PR） |
