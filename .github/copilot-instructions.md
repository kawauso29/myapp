...
GitHub Copilot（コーディングエージェント）向けのプロジェクトメモ。
...
- **重要な情報が出てきたら必ずこの copilot-instructions.md に追記する**
- **間違いを指摘されたら、その内容と正しい情報を copilot-instructions.md に記録する**
