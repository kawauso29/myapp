...
| 運営 OS Phase 30〜41 実装 | `docs/projects/operating-spec-phase-30-plan.md` | ✅ ほぼ完了（Phase 30〜37 / 39 / 38b / 41b 完了 + 補強9 template_id + enforce モード機構 + Phase 40 LlmGateway augment hook。本番での enforce ON タイミングのみ残件） |
